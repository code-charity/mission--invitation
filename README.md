...
###### _Opportunity:_  
  - a Developer's work can sometimes be leveraged easily, so that it saves 1000s of times more human effort collectively than it costs  the one or few developers...! - Or electricity too - And still in the future, if society progresses and the amount of developers grows, there will still be little features never made or published before, that 10000s smart people were waiting for already - or that millions would enjoy *if* only they ever see it structured (effiently). 

- So in turn translating, documentating, structuring, planning can also be very efficient/motivating.
...
(A single person's energy simply is limited.  A project can easily be too big or too lengthy (many years or decades)

   - to date only <1.75% of popular repos are forks & <1.31% among those updated. <br> (_=<code>fork:only stars:>130 pushed>2021-01</code> ... to be repeated_ ) <br> <img width="268" align="right" alt="only 2% forks" src="https://user-images.githubusercontent.com/25022245/151553999-7a774d7e-05f0-48bd-abe7-f486a30a2eae.png">
